 ...
 */
public abstract class BaseSwipeMenuListFragment extends BaseFragment implements OnRefreshListener<SwipeMenuListView>, OnItemClickListener,
	...
	public void initializeView(View v) {
		mPullToRefresh = (PullToRefreshSwipeMenuListView) v.findViewById(R.id.generalPullToRefreshLsv);
