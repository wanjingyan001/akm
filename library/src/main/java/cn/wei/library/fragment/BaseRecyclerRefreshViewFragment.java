 ...
 */
public abstract class BaseRecyclerRefreshViewFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public class DataAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (VIEW_TYPE_FOOTER == viewType) {
                return new FooterViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.recycler_footer, parent, false));
            ...
            return BaseRecyclerRefreshViewFragment.this.onCreateViewHolder(parent, viewType);
        }
