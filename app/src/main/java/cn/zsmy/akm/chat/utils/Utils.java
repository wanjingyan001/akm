...
//	}
	...
	public static boolean isImage(String file_type) {
		if (Attachment.AttachmentType.BMP.fetchMimeType().equalsIgnoreCase(file_type) || Attachment.AttachmentType.PNG.fetchMimeType().equalsIgnoreCase(file_type)
				|| Attachment.AttachmentType.JPEG.fetchMimeType().equalsIgnoreCase(file_type) || Attachment.AttachmentType.JPG.fetchMimeType().equalsIgnoreCase(file_type)) {
			return true;
		}
		return false;
	}
