...
import cn.zsmy.akm.chat.holder.ChatHolder;
...
public class ChatAdapter extends BaseAdapter {
        ...
        public void initializeData(int position) {
            ...
            if (message != null) {
                if (receiverIcon != null) {
                    ImageLoader.getInstance().displayImage(UrlHelpper.FILE_IP + receiverIcon, head_pic);
                }
    ...
    public class ChatTextHolderRight extends ChatHolder {
        ...
        public void initializeData(int position) {
            ...
            if (message != null) {
                if (senderIcon != null) {
                    ImageLoader.getInstance().displayImage(UrlHelpper.FILE_IP + senderIcon, head_pic);
                }
                chat_content.setText(message.getContent());
            }
        }
    ...
    public class ChatImageHolderLeft extends ChatHolder {
        ...
        public void initializeData(int position) {
            ...
            if (message != null) {
                ...
                ImageLoader.getInstance().displayImage(UrlHelpper.FILE_IP + message.getContent(), chat_pic);
            }
        }
    }
