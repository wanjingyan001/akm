...
import cn.zsmy.akm.db.ConversationController;
...
public class Message implements Serializable {
    ...
    @DatabaseField
    private String receiver_voice;// 音频消息
    @DatabaseField
    ...
    public String getReceiver_voice() {
        return receiver_voice;
    }

    public void setReceiver_voice(String receiver_voice) {
        this.receiver_voice = receiver_voice;
    }
