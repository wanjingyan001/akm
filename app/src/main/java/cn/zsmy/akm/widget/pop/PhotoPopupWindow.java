...
public class  PhotoPopupWindow {
     ...
     * @param title   标题
     */
    public PhotoPopupWindow(Context context, String title) {
        this.mContext = context;
        this.mTitle = title;
    }
    ...
    private void addView(View v) {
        ...
        if (options != null && options.length > 0) {
            for (int i = 0; i < options.length; i++) {
                View item = LayoutInflater.from(mContext).inflate(R.layout.m_pop_window_button, null);
    ...
    public void showPopupWindow() {
        View popupWindow_view = LayoutInflater.from(mContext).inflate(R.layout.m_photo_poppupwindow, null);
        //添加子View
