    ...
    public class DrugAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.item_select_drug, null);
            ...
            public void initializeData(int position) {
                ...
                if (dataEntity != null) {
                    ...
                    if (dataEntity.getIcon() != null) {
                        ImageLoader.getInstance().displayImage(UrlHelper.IP + dataEntity.getIcon(), drugImg);
                    }
                }
            }
        }
