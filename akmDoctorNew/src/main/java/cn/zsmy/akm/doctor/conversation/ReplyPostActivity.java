...
import cn.zsmy.akm.doctor.widget.dialog.ReplyDialog;
...
public class ReplyPostActivity extends BaseTitleActivity {
    ...
    protected void initializeData() {
        ...
        if (comment1 != null) {
            ...
            ForegroundColorSpan span = new ForegroundColorSpan(getResources().getColor(R.color.app_main_color));
    ...
    private void submitReply(String value) {
        ...
        Request request = new Request(UrlHelper.SUBMIT_REPLY, Request.RequestMethod.POST, this);
